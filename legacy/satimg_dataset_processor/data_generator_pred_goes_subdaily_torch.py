...
class FireDatasetWithGOESSubdaily(Dataset):
    def __init__(
        self,
        image_path,
        label_path,
    ...
    def __getitem__(self, idx):
        x, y, goes_subdaily = self.load_data(idx)
    ...
    def load_data(self, indices):
        ...
        goes_subdaily = torch.squeeze(torch.from_numpy(goes_subdaily_chunk.copy())).float()
        return x, y, goes_subdaily
